 ...
 * 
 * @export
 * @interface Create3RequestItemsInner
 */
export interface Create3RequestItemsInner {
    /**
     * 
     * @type {number}
     * @memberof Create3RequestItemsInner
     */
    productId: number;
    /**
     * 
...
/**
 * Check if a given object implements the Create3RequestItemsInner interface.
 */
export function instanceOfCreate3RequestItemsInner(value: object): boolean {
    let isInstance = true;
...
export function Create3RequestItemsInnerFromJSON(json: any): Create3RequestItemsInner {
    return Create3RequestItemsInnerFromJSONTyped(json, false);
}

export function Create3RequestItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): Create3RequestItemsInner {
    ...
    return {
        ...
        'unitCost': !exists(json, 'unit_cost') ? undefined : json['unit_cost'],
        'unitId': !exists(json, 'unit_id') ? undefined : json['unit_id'],
    };
}

export function Create3RequestItemsInnerToJSON(value?: Create3RequestItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
