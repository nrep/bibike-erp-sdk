 ...
 * 
 * @export
 * @interface Update9Request
 */
export interface Update9Request {
    /**
     * 
     * @type {string}
     * @memberof Update9Request
     */
    name?: string;
    /**
     * 
...
/**
 * Check if a given object implements the Update9Request interface.
 */
export function instanceOfUpdate9Request(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Update9RequestFromJSON(json: any): Update9Request {
    return Update9RequestFromJSONTyped(json, false);
}

export function Update9RequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): Update9Request {
...
export function Update9RequestToJSON(value?: Update9Request | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
