...
import type { Login200ResponseOneOf } from './Login200ResponseOneOf';
import {
    instanceOfLogin200ResponseOneOf,
    Login200ResponseOneOfFromJSON,
    Login200ResponseOneOfFromJSONTyped,
    Login200ResponseOneOfToJSON,
} from './Login200ResponseOneOf';
import type { Login200ResponseOneOf1 } from './Login200ResponseOneOf1';
import {
    instanceOfLogin200ResponseOneOf1,
    Login200ResponseOneOf1FromJSON,
    Login200ResponseOneOf1FromJSONTyped,
    Login200ResponseOneOf1ToJSON,
} from './Login200ResponseOneOf1';
 ...
 * @export
 */
export type Login200Response = Login200ResponseOneOf | Login200ResponseOneOf1;
...
export function Login200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Login200Response {
    ...
    return { ...Login200ResponseOneOfFromJSONTyped(json, true), ...Login200ResponseOneOf1FromJSONTyped(json, true) };
}
...
export function Login200ResponseToJSON(value?: Login200Response | null): any {
    ...
    if (instanceOfLogin200ResponseOneOf(value)) {
        return Login200ResponseOneOfToJSON(value as Login200ResponseOneOf);
    }
    if (instanceOfLogin200ResponseOneOf1(value)) {
        return Login200ResponseOneOf1ToJSON(value as Login200ResponseOneOf1);
    }
