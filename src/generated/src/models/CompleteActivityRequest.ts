...
export interface CompleteActivityRequest {
     ...
     * 
     * @type {string}
     * @memberof CompleteActivityRequest
     */
    notes?: string;
}

/**
 * Check if a given object implements the CompleteActivityRequest interface.
 */
export function instanceOfCompleteActivityRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CompleteActivityRequestFromJSON(json: any): CompleteActivityRequest {
    return CompleteActivityRequestFromJSONTyped(json, false);
}

export function CompleteActivityRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompleteActivityRequest {
...
export function CompleteActivityRequestToJSON(value?: CompleteActivityRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
