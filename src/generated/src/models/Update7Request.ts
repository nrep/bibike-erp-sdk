 ...
 * 
 * @export
 * @interface Update7Request
 */
export interface Update7Request {
    /**
     * 
     * @type {string}
     * @memberof Update7Request
     */
    fullName?: string;
    /**
     * 
...
/**
 * Check if a given object implements the Update7Request interface.
 */
export function instanceOfUpdate7Request(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Update7RequestFromJSON(json: any): Update7Request {
    return Update7RequestFromJSONTyped(json, false);
}

export function Update7RequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): Update7Request {
...
export function Update7RequestToJSON(value?: Update7Request | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
