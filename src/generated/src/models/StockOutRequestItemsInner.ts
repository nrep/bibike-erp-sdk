 ...
 * 
 * @export
 * @interface StockOutRequestItemsInner
 */
export interface StockOutRequestItemsInner {
    /**
     * 
     * @type {number}
     * @memberof StockOutRequestItemsInner
     */
    productId: number;
    /**
     * 
...
/**
 * Check if a given object implements the StockOutRequestItemsInner interface.
 */
export function instanceOfStockOutRequestItemsInner(value: object): boolean {
    let isInstance = true;
...
export function StockOutRequestItemsInnerFromJSON(json: any): StockOutRequestItemsInner {
    return StockOutRequestItemsInnerFromJSONTyped(json, false);
}

export function StockOutRequestItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): StockOutRequestItemsInner {
...
export function StockOutRequestItemsInnerToJSON(value?: StockOutRequestItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
