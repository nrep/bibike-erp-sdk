 ...
 * 
 * @export
 * @interface Create8Request
 */
export interface Create8Request {
    /**
     * 
     * @type {string}
     * @memberof Create8Request
     */
    name: string;
    /**
     * 
...
/**
 * Check if a given object implements the Create8Request interface.
 */
export function instanceOfCreate8Request(value: object): boolean {
    let isInstance = true;
...
export function Create8RequestFromJSON(json: any): Create8Request {
    return Create8RequestFromJSONTyped(json, false);
}

export function Create8RequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): Create8Request {
...
export function Create8RequestToJSON(value?: Create8Request | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
