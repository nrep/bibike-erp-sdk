...
export interface MoveStageRequest {
     ...
     * 
     * @type {number}
     * @memberof MoveStageRequest
     */
    stageId: number;
}

/**
 * Check if a given object implements the MoveStageRequest interface.
 */
export function instanceOfMoveStageRequest(value: object): boolean {
    let isInstance = true;
...
export function MoveStageRequestFromJSON(json: any): MoveStageRequest {
    return MoveStageRequestFromJSONTyped(json, false);
}

export function MoveStageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): MoveStageRequest {
...
export function MoveStageRequestToJSON(value?: MoveStageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
