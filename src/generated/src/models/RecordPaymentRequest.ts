...
/**
 * Check if a given object implements the RecordPaymentRequest interface.
 */
export function instanceOfRecordPaymentRequest(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "saleId" in value;
...
export function RecordPaymentRequestFromJSON(json: any): RecordPaymentRequest {
    return RecordPaymentRequestFromJSONTyped(json, false);
}

export function RecordPaymentRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecordPaymentRequest {
...
export function RecordPaymentRequestToJSON(value?: RecordPaymentRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
