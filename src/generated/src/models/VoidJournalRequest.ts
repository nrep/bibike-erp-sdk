 ...
 * 
 * @export
 * @interface VoidJournalRequest
 */
export interface VoidJournalRequest {
    /**
     * 
     * @type {string}
     * @memberof VoidJournalRequest
     */
    reason: string;
}

/**
 * Check if a given object implements the VoidJournalRequest interface.
 */
export function instanceOfVoidJournalRequest(value: object): boolean {
    let isInstance = true;
...
export function VoidJournalRequestFromJSON(json: any): VoidJournalRequest {
    return VoidJournalRequestFromJSONTyped(json, false);
}

export function VoidJournalRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): VoidJournalRequest {
...
export function VoidJournalRequestToJSON(value?: VoidJournalRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
