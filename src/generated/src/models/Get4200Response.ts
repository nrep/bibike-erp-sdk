 ...
 * 
 * @export
 * @interface Get4200Response
 */
export interface Get4200Response {
    /**
     * 
     * @type {boolean}
     * @memberof Get4200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the Get4200Response interface.
 */
export function instanceOfGet4200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Get4200ResponseFromJSON(json: any): Get4200Response {
    return Get4200ResponseFromJSONTyped(json, false);
}

export function Get4200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Get4200Response {
...
export function Get4200ResponseToJSON(value?: Get4200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
