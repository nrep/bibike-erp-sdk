 ...
 * 
 * @export
 * @interface Update8Request
 */
export interface Update8Request {
    /**
     * 
     * @type {number}
     * @memberof Update8Request
     */
    id: number;
    /**
     * 
...
/**
 * Check if a given object implements the Update8Request interface.
 */
export function instanceOfUpdate8Request(value: object): boolean {
    let isInstance = true;
...
export function Update8RequestFromJSON(json: any): Update8Request {
    return Update8RequestFromJSONTyped(json, false);
}

export function Update8RequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): Update8Request {
    ...
    return {
        ...
        'permissionIds': !exists(json, 'permission_ids') ? undefined : json['permission_ids'],
    };
}

export function Update8RequestToJSON(value?: Update8Request | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
