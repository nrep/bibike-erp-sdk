...
/**
 * Check if a given object implements the Accounts200Response interface.
 */
export function instanceOfAccounts200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Accounts200ResponseFromJSON(json: any): Accounts200Response {
    return Accounts200ResponseFromJSONTyped(json, false);
}

export function Accounts200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Accounts200Response {
...
export function Accounts200ResponseToJSON(value?: Accounts200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
