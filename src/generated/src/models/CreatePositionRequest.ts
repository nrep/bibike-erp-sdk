 ...
 */
export function instanceOfCreatePositionRequest(value: object): boolean {
    let isInstance = true;
...
export function CreatePositionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreatePositionRequest {
    ...
    return {
        ...
        'minSalary': !exists(json, 'min_salary') ? undefined : json['min_salary'],
        'maxSalary': !exists(json, 'max_salary') ? undefined : json['max_salary'],
    };
}

export function CreatePositionRequestToJSON(value?: CreatePositionRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
