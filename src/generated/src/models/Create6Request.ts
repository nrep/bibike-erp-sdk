 ...
 * 
 * @export
 * @interface Create6Request
 */
export interface Create6Request {
    /**
     * 
     * @type {string}
     * @memberof Create6Request
     */
    name: string;
    /**
     * 
...
/**
 * Check if a given object implements the Create6Request interface.
 */
export function instanceOfCreate6Request(value: object): boolean {
    let isInstance = true;
...
export function Create6RequestFromJSON(json: any): Create6Request {
    return Create6RequestFromJSONTyped(json, false);
}

export function Create6RequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): Create6Request {
...
export function Create6RequestToJSON(value?: Create6Request | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
