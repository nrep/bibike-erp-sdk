...
/**
 * Check if a given object implements the StockInRequest interface.
 */
export function instanceOfStockInRequest(value: object): boolean {
    let isInstance = true;
...
export function StockInRequestFromJSON(json: any): StockInRequest {
    return StockInRequestFromJSONTyped(json, false);
}

export function StockInRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): StockInRequest {
...
export function StockInRequestToJSON(value?: StockInRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
