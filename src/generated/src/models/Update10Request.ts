 ...
 * 
 * @export
 * @interface Update10Request
 */
export interface Update10Request {
    /**
     * 
     * @type {string}
     * @memberof Update10Request
     */
    url?: string;
    /**
     * 
...
/**
 * Check if a given object implements the Update10Request interface.
 */
export function instanceOfUpdate10Request(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Update10RequestFromJSON(json: any): Update10Request {
    return Update10RequestFromJSONTyped(json, false);
}

export function Update10RequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): Update10Request {
...
export function Update10RequestToJSON(value?: Update10Request | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
