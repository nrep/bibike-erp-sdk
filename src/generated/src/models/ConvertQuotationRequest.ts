...
export interface ConvertQuotationRequest {
     ...
     * 
     * @type {string}
     * @memberof ConvertQuotationRequest
     */
    convertTo?: ConvertQuotationRequestConvertToEnum;
}
 ...
 * @export
 */
export const ConvertQuotationRequestConvertToEnum = {
    Order: 'order',
    Invoice: 'invoice'
} as const;
export type ConvertQuotationRequestConvertToEnum = typeof ConvertQuotationRequestConvertToEnum[keyof typeof ConvertQuotationRequestConvertToEnum];


/**
 * Check if a given object implements the ConvertQuotationRequest interface.
 */
export function instanceOfConvertQuotationRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ConvertQuotationRequestFromJSON(json: any): ConvertQuotationRequest {
    return ConvertQuotationRequestFromJSONTyped(json, false);
}

export function ConvertQuotationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConvertQuotationRequest {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'convertTo': !exists(json, 'convert_to') ? undefined : json['convert_to'],
    };
}

export function ConvertQuotationRequestToJSON(value?: ConvertQuotationRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
