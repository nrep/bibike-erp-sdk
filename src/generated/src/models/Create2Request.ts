...
/**
 * Check if a given object implements the Create2Request interface.
 */
export function instanceOfCreate2Request(value: object): boolean {
    let isInstance = true;
...
export function Create2RequestFromJSON(json: any): Create2Request {
    return Create2RequestFromJSONTyped(json, false);
}

export function Create2RequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): Create2Request {
...
export function Create2RequestToJSON(value?: Create2Request | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
