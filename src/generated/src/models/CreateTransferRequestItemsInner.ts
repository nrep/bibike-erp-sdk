 ...
 * 
 * @export
 * @interface CreateTransferRequestItemsInner
 */
export interface CreateTransferRequestItemsInner {
    /**
     * 
     * @type {number}
     * @memberof CreateTransferRequestItemsInner
     */
    productId: number;
    /**
     * 
...
/**
 * Check if a given object implements the CreateTransferRequestItemsInner interface.
 */
export function instanceOfCreateTransferRequestItemsInner(value: object): boolean {
    let isInstance = true;
...
export function CreateTransferRequestItemsInnerFromJSON(json: any): CreateTransferRequestItemsInner {
    return CreateTransferRequestItemsInnerFromJSONTyped(json, false);
}

export function CreateTransferRequestItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateTransferRequestItemsInner {
...
export function CreateTransferRequestItemsInnerToJSON(value?: CreateTransferRequestItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
