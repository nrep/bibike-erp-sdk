 ...
 * 
 * @export
 * @interface Verify2fa200ResponseData
 */
export interface Verify2fa200ResponseData {
    /**
     * 
     * @type {string}
     * @memberof Verify2fa200ResponseData
     */
    token?: string;
    /**
     * 
...
/**
 * Check if a given object implements the Verify2fa200ResponseData interface.
 */
export function instanceOfVerify2fa200ResponseData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Verify2fa200ResponseDataFromJSON(json: any): Verify2fa200ResponseData {
    return Verify2fa200ResponseDataFromJSONTyped(json, false);
}

export function Verify2fa200ResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): Verify2fa200ResponseData {
...
export function Verify2fa200ResponseDataToJSON(value?: Verify2fa200ResponseData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
