 ...
 */
export function instanceOfCreateDepartmentRequest(value: object): boolean {
    let isInstance = true;
...
export function CreateDepartmentRequestFromJSON(json: any): CreateDepartmentRequest {
    return CreateDepartmentRequestFromJSONTyped(json, false);
}

export function CreateDepartmentRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateDepartmentRequest {
    ...
    return {
        ...
        'managerId': !exists(json, 'manager_id') ? undefined : json['manager_id'],
    };
}

export function CreateDepartmentRequestToJSON(value?: CreateDepartmentRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
