...
/**
 * Check if a given object implements the UpdateOpportunityRequest interface.
 */
export function instanceOfUpdateOpportunityRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UpdateOpportunityRequestFromJSON(json: any): UpdateOpportunityRequest {
    return UpdateOpportunityRequestFromJSONTyped(json, false);
}

export function UpdateOpportunityRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateOpportunityRequest {
...
export function UpdateOpportunityRequestToJSON(value?: UpdateOpportunityRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
