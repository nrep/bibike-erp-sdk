 ...
 * 
 * @export
 * @interface ReceiveGoodsRequestItemsInner
 */
export interface ReceiveGoodsRequestItemsInner {
    /**
     * 
     * @type {number}
     * @memberof ReceiveGoodsRequestItemsInner
     */
    productId: number;
    /**
     * 
...
/**
 * Check if a given object implements the ReceiveGoodsRequestItemsInner interface.
 */
export function instanceOfReceiveGoodsRequestItemsInner(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "productId" in value;
    isInstance = isInstance && "quantityReceived" in value;

    return isInstance;
}

export function ReceiveGoodsRequestItemsInnerFromJSON(json: any): ReceiveGoodsRequestItemsInner {
    return ReceiveGoodsRequestItemsInnerFromJSONTyped(json, false);
}

export function ReceiveGoodsRequestItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReceiveGoodsRequestItemsInner {
...
export function ReceiveGoodsRequestItemsInnerToJSON(value?: ReceiveGoodsRequestItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
